...
/*
$result2 = "SELECT * FROM `Student` WHERE `Log_In` = '$login' AND `Password` = '$password'";
$user = $mysqli->query($result2);*/
$result = $mysqli->query("SELECT * FROM `Student` WHERE `Log_In` = '$login' AND `Password` = '$password'");
